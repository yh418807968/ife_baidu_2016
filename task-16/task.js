...
function renderAqiList() {
	var newlist=[];
	var firstRow="<tr><td>城市</td><td>空气质量</td><td>操作</td></tr>";
	newlist.push(firstRow);
	for(city in aqiData){
	var text="<tr><td>"+city+"</td><td>"+aqiData[city]+"</td><td><button data-city='"+city+"'>删除</button></td></tr>";
	newlist.push(text);
		}
	document.getElementById("aqi-table").innerHTML=newlist.join("");
